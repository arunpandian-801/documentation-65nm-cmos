!!! warning "Disclaimer"
    ...
    The documentation is Licensed under **CC BY 4.0**, while the QUCS-S Schematics are Licensed under **MIT License**. Read the `LICENSE.md` in each of these repositories for more information.